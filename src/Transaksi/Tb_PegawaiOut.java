 ...
 * @author USER
 */
public class Tb_PegawaiOut extends javax.swing.JDialog {
    ...
    /**
     * Creates new form Tb_PegawaiOut
     */
    public Tb_PegawaiOut(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dataTable();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Data Pegawai Keluar");
        ...
        tbData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NIK", "Nama", "Jenis Kelamin", "Tanggal Lahir", "Agama", "No.Hp", "Alamat"
            }
        ) {
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        if (txtNik.getText().equals("")){
            ...
            String sql = "insert into tb_pegawaiout (nik,nama,jenis_kelamin,tanggal_lahir,agama,no_hp,alamat) values (?,?,?,?,?,?,?)";
            try {
    ...
    int ok = JOptionPane.showConfirmDialog(null, "Apakah Mau Menghapus Data Ini?","Konfirmasi Dialog", JOptionPane.YES_NO_OPTION);
        if(ok == 0){
            String sql = "delete from tb_pegawaiout where nik = '"+txtNik.getText()+"'";
            try{
                PreparedStatement stat = conn.prepareStatement(sql);
                stat.executeUpdate();
...
String sql = "update tb_pegawaiout set nik=?, nama=?, jenis_kelamin=?, tanggal_lahir=? ,agama=? ,no_hp=? ,alamat=? where nik ='"+ txtNik.getText() + "'";
        try {
            PreparedStatement stat = conn.prepareStatement(sql);
                stat.setString(1, txtNik.getText());
                stat.setString(2, txtNama.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tb_PegawaiOut.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Tb_PegawaiOut dialog = new Tb_PegawaiOut(new javax.swing.JFrame(), true);
