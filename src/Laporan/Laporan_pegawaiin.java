 ...
 * @author USER
 */
public class Laporan_pegawaiin extends javax.swing.JDialog {
   ...
   public final Connection conn = new koneksi().connect();
    ...
    public Laporan_pegawaiin(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        tampil_combo1();
        tampil_combo2();
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        try {
            File file = new File("src/Laporan/Lap_Pegawaiin.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Laporan_pegawaiin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Laporan_pegawaiin dialog = new Laporan_pegawaiin(new javax.swing.JFrame(), true);
